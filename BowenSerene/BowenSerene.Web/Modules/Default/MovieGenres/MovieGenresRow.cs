...
namespace BowenSerene.Default.Entities
{
    ...
    [ConnectionKey("Default"), TableName("[dbo].[MovieGenres]")]
    [DisplayName("Movie Genres"), InstanceName("Movie Genres"), TwoLevelCached]
    ...
    public sealed class MovieGenresRow : Row, IIdRow
    {
        ...
        [DisplayName("Genre Create Date"), Expression("jGenre.[CreateDate]")]
        public DateTime? GenreCreateDate
        {
            get { return Fields.GenreCreateDate[this]; }
            set { Fields.GenreCreateDate[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DateTimeField GenreCreateDate;
