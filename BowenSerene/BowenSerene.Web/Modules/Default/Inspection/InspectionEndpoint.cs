...
namespace BowenSerene.Default.Endpoints
{
    ...
    using MyRepository = Repositories.InspectionRepository;
    using MyRow = Entities.InspectionRow;

    [RoutePrefix("Services/Default/Inspection"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class InspectionController : ServiceEndpoint
    {
