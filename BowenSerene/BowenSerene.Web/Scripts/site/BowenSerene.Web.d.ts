...
declare namespace BowenSerene.Default {
    ...
    namespace PurchaseOrderDetailRow {
        ...
        namespace Fields {
            ...
            const ProNumber: string;
            const ProName: string;
            const ProType: string;
            const ProMine: string;
            const ProGrade: string;
            const ProDensity: string;
            const BuyCount: string;
            const Length: string;
            const Width: string;
            const Height: string;
            const Thick: string;
            ...
            const AssignUserId: string;
            const AssignUserName: string;
            const InsertUserId: string;
            const InsertDate: string;
            const UpdateUserId: string;
            const UpdateDate: string;
...
declare namespace BowenSerene.Default {
    ...
    namespace PurchaseOrderRow {
        ...
        namespace Fields {
            ...
            const Status: string;
            const IsPay: string;
            const DeleteMark: string;
            const BuyUserId: string;
            const PurchaseDate: string;
            const SupplierId: string;
            const SupplierNumber: string;
            const LetterNumber: string;
            const EstimateTotal: string;
            const ReckonTotal: string;
            const TotalSize: string;
            const TotalWeight: string;
            const TotalVolume: string;
            const TotalContainer: string;
            const TotalBuyCount: string;
            const TotalPieceCount: string;
            const Notes: string;
