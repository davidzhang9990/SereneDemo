...
(function (BowenSerene) {
    ...
    (function (Default) {
        var PurchaseOrderDetailEditor = /** @class */ (function (_super) {
            ...
            function PurchaseOrderDetailEditor(container, entity) {
                var _this = _super.call(this, container) || this;
                _this.pendingChanges = {};
                Q.log(entity);
                _this.slickContainer.on('change', '.edit:input', function (e) { return _this.inputsChange(e); });
            ...
            //        }
            PurchaseOrderDetailEditor.prototype.createSlickGrid = function (entity) {
            ...
            */
            ...
            PurchaseOrderDetailEditor.prototype.clearView = function () {
                var items = this.view.getItems().slice();
