namespace BowenSerene.Default {
    export namespace PurchaseOrderDetailService {
        export const baseUrl = 'Default/PurchaseOrderDetail';
        ...
        export declare function ExcelImport(request: ExcelImportRequest, onSuccess?: (response: ProductsImportResponse<PurchaseOrderDetailRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
